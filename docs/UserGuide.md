...
Examples:
*  `edit 1 p/91234567 c/johndoe@example.com` Edits the phone number and contact detail of the 1st person to be `91234567` and `johndoe@example.com` respectively.
