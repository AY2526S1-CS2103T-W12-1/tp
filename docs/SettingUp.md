...
1. **Learn the design**
   ...
   When you are ready to start coding, we recommend that you get some sense of the overall design by reading about [Maplet’s architecture](DeveloperGuide.md#architecture).
