 ...
 * A attraction is considered unique by comparing using {@code Attraction#isSameAttraction(Attraction)}. As such, adding
 * and updating of attractions uses Attraction#isSameAttraction(Attraction) for equality so as to ensure that the
 * attraction being added or updated is unique in terms of identity in the UniqueAttractionList. However, the removal of
 * a attraction uses Attraction#equals(Object) so as to ensure that the attraction with exactly the same fields will be
 * removed.
 *
...
public class UniqueAttractionList implements Iterable<Attraction> {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof UniqueAttractionList)) {
            return false;
        }

        UniqueAttractionList otherUniqueAttractionList = (UniqueAttractionList) other;
        return internalList.equals(otherUniqueAttractionList.internalList);
    }
