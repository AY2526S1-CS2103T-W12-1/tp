...
public class EditCommandParserTest {
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, "1" + INVALID_NAME_DESC + INVALID_EMAIL_DESC + VALID_ADDRESS_AMY + VALID_PRIORITY_AMY,
    ...
    public void parse_multipleRepeatedFields_failure() {
        ...
        userInput = targetIndex.getOneBased() + PRIORITY_DESC_AMY + ADDRESS_DESC_AMY + EMAIL_DESC_AMY
        ...
        userInput = targetIndex.getOneBased() + INVALID_PRIORITY_DESC + INVALID_ADDRESS_DESC + INVALID_EMAIL_DESC
                + INVALID_PRIORITY_DESC + INVALID_ADDRESS_DESC + INVALID_EMAIL_DESC;
