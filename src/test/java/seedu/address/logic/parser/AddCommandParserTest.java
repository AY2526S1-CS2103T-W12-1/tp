...
public class AddCommandParserTest {
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedPersonString = NAME_DESC_BOB + PRIORITY_DESC_BOB + CONTACT_DESC_BOB
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PRIORITY_DESC + CONTACT_DESC_BOB + ADDRESS_DESC_BOB
                + ACTIVITIES_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Priority.MESSAGE_CONSTRAINTS);
