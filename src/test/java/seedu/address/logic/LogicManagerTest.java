...
import static seedu.address.logic.Messages.MESSAGE_INVALID_ATTRACTION_DISPLAYED_INDEX;
...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonMapletStorage mapletStorage =
                new JsonMapletStorage(temporaryFolder.resolve("maplet.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(mapletStorage, userPrefsStorage);
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        ...
        assertCommandException(deleteCommand, MESSAGE_INVALID_ATTRACTION_DISPLAYED_INDEX);
    }
    ...
    public void getLocationList_modifyList_throwsUnsupportedOperationException() {
        assertThrows(UnsupportedOperationException.class, () -> logic.getLocationList().remove(0));
    }
    ...
    private void assertCommandFailureForExceptionFromStorage(IOException e, String expectedMessage) {
        ...
        // Inject LogicManager with an MapletStorage that throws the IOException e when saving
        JsonMapletStorage mapletStorage = new JsonMapletStorage(prefPath) {
            @Override
            public void saveMaplet(ReadOnlyMaplet maplet, Path filePath)
                    throws IOException {
                throw e;
            }
        };
